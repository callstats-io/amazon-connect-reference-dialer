		...
		return (
			<div className={"col-md-12 ml-4"}>
				<ul id="dialPadKeyboard">
					...
					<li className="letter  clearl" onClick={handleClick.bind(this, '4')} value={'4'}>4</li>
					...
					<li className="letter clearl" onClick={handleClick.bind(this, '7')} value={'7'}>7</li>
					...
					<li className="letter clearl" onClick={handleClick.bind(this, '*')} value={'*'}>*</li>
