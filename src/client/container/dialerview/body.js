...
class Body extends Component {
  constructor(props) {
    ...
    this.state = {
      phoneNumber: "",
      defaultCountry:
        databaseManager.getDefaultCountry() ||
        lo.first(sessionManager.getDialableCountries(), "fi"),
      errorCount: 0
    };
  ...
  dialNumber() {
    ...
    sessionManager.dialNumber(phoneNumber).then(
      success => {
        this.closeDialPad();
      },
      err => {
    ...
    return (
      <div className="card-body" style={{ backgroundColor: "#ffffff" }}>
        <div className="row">
          ...
          <div className="col-2" onClick={() => this.closeDialPad()}>
        ...
        <div className="row mt-2">
          ...
          <div className="col-3 p-0 m-0">
            <a
              className={`btn ${styles.dialButton}`}
